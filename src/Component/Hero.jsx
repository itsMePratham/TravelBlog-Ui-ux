...
function Hero({ hero: {title,subtitle ,text ,btn1 ,btn2 ,img}}) {
  return (
    <div className='flex flex-col bg-gradient-to-b from-emerald-200 to-white h-auto w-auto'>
         <div className='travigo-container grid   justify-items-center'>
            <div className='grid items-center justify-items-center mt-36 mb-16 md:mt-28 md:mb-12'>
                ...
                <div className='flex items-center justify-center gap-11 sm:gap-3 sm:flex-col sm:w-full'>
                    ...
                    <button type='' className='button-light'
                    >{btn2}</button>
                </div>
            </div>
            <div className='flex items-center justify-center mb-11'>
                <img  className='h-[85vh] w-full object-fill lg:h-[75vh] md:h-[57vh] sm:h-[35vh] sm:object-contain drop-shadow-emrald' src={img} alt="" />
            </div>
         </div>
    </div>
  )
